  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
        ...
        child: OutlinedButton(
            style: ButtonStyle(
                overlayColor: overlayColor != null && showOverlayColor!
                    ? MaterialStateProperty.all(overlayColor)
                    : showOverlayColor!
                        ? MaterialStateProperty.all(
                            Theme.of(context).primaryColor.withOpacity(0.1))
                        : null,
                foregroundColor: buttomColor != null
                    ? MaterialStateProperty.all(buttomColor)
                    : MaterialStateProperty.all(Theme.of(context).primaryColor),
                side: buttomColor != null
                    ? MaterialStateProperty.all(borderSide != null
                        ? BorderSide(width: borderSide!, color: buttomColor!)
                ...
                shadowColor: shadowColor != null && showShadowColor!
