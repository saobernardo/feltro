...
class _ProgressButtonState extends State<ProgressButton>
  ...
  Widget _buildChild(BuildContext context) {
    var padding = MaterialStateProperty.all(const EdgeInsets.all(0.0));
    var color = MaterialStateProperty.all(widget.color);
    ...
    switch (widget.type) {
      ...
      case ProgressButtonType.Outline:
        return OutlinedButton(
          ...
          // color: color,
          // shape: shape,
          style: ButtonStyle(padding: padding, shape: shape
